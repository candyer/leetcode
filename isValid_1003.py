...
assert isValid("aabcbc") == True
assert isValid("abcabcababcc") == True
assert isValid("abccba") == False
assert isValid("cababc") == False
assert isValid("bac") == False
assert isValid("c") == False
assert isValid("aababccbabcc") == True
