...
assert constructRectangle(3) == [3, 1]
assert constructRectangle(1) == [1, 1]
assert constructRectangle(11) == [11, 1]
assert constructRectangle(20) == [5, 4]
assert constructRectangle(25) == [5, 5]
assert constructRectangle(30) == [6, 5]
assert constructRectangle(100) == [10, 10]
assert constructRectangle(37) == [37, 1]
assert constructRectangle(10000000) == [3200,3125]
