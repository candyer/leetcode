...
# Each video clip clips[i] is an interval: it starts at time clips[i][0] and ends at time clips[i][1].  We can cut these clips into 
...
assert videoStitching([[0, 8], [4, 8], [6, 12], [11, 12]], 11) == 2
assert videoStitching([[0, 10], [4, 9], [6, 8], [11, 12]], 10) == 1
...
assert videoStitching([[0,4],[2,8]], 5) == 2
