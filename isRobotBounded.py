...
def isRobotBounded(instructions):
	...
	while i < len(instructions):
		...
		i += 1
	return direction != 'N' or direction == 'N' and (x, y) == (0, 0)

assert isRobotBounded("GGLLGG") == True
assert isRobotBounded("GG") == False
assert isRobotBounded("GL") == True
assert isRobotBounded("RGRRGRRRGRRRRG") == True
assert isRobotBounded("RR") == True
assert isRobotBounded("R") == True
assert isRobotBounded("L") == True
assert isRobotBounded("RRGRRGLLLRLGGLGLLGRLRLGLRLRRGLGGLLRRRLRLRLLGRGLGRRRGRLG") == False
assert isRobotBounded("LRRRRLLLRL") == True
