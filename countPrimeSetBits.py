...
# Example 1:   Input: L = 6, R = 10   Output: 4
# Explanation:
...
# Example 2:   Input: L = 10, R = 15   Output: 5
# Explanation:
# 10 -> 1010 (2 set bits, 2 is prime)
...
assert countPrimeSetBits(720584, 729197) == 2493
assert countPrimeSetBits(999000, 1000000) == 272
