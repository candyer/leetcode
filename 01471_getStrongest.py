...
assert(getStrongest([1,2,3,4,5], 2) == [5, 1])
assert(getStrongest([1,1,3,5,5], 2) == [5, 5])
assert(getStrongest([6,7,11,7,6,8], 5) == [11, 8, 6, 6, 7])
assert(getStrongest([6,-3,7,2,11], 3) == [-3, 11, 2])
assert(getStrongest([-7,22,17,3], 2) == [22, 17])
