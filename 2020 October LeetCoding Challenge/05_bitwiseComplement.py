...
# The complement of a binary representation is the number in binary you get when changing every 1 to a 0 and 
# 0 to a 1.  For example, the complement of "101" in binary is "010" in binary.
